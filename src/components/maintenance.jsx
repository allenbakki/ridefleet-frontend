...
const Maintenance = ({ vehicleId, setTotalSpend, totalSpent }) => {
  ...
  const handleAddMaintenance = (values) => {
    axios
      .post("http://localhost:8000/add-maintenance", {
        vehicleNo: vehicleId,
        ...values,
      })
      .then((response) => {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <div style={{ fontSize: 24, fontWeight: "bold" }}>Maintenance History</div>
